    ...
    <div className="mx-auto max-w-7xl px-4 py-8">
      ...
      <div className="mb-8 pb-6 border-b border-stone-200">
        <div className="flex items-end justify-between">
          <div>
            <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-amber-500 mb-2">Account</p>
            <h1 className="text-3xl md:text-4xl font-black tracking-tight text-stone-900 font-serif leading-tight">Your Account.</h1>
          </div>
          <Link
            to="/home"
                  ...
                  >
                    <span
                      className={`w-1.5 h-1.5 rounded-full shrink-0 transition-all ${
                        active ? 'bg-stone-900' : 'bg-stone-600 group-hover:bg-stone-400'
                      }`}
                    />
                    {item.label}
                    {active && (
