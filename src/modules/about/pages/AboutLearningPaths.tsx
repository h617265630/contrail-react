        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 md:py-24">
          <div className="max-w-2xl">
            ...
            <h1 className="text-5xl md:text-7xl font-black tracking-tight text-stone-900 leading-[0.92] mb-8">
              Learning
              <br />
              <span className="text-sky-600">paths</span>
              <br />
              that work.
            </h1>

            <p className="text-base leading-relaxed text-stone-600 max-w-lg">
              Learning paths turn resources into a sequence: what to learn, in
              what order, and why. Build a path that matches your goal and keep
              it iterative.
            </p>
          </div>
        </div>
          ...
          <div className="col-span-12 md:col-span-5">
            <div className="sticky top-24">
              ...
              <p className="text-sm leading-relaxed text-stone-500 mb-6">
                A learning path is more than a list of links. It's a intentional
                sequence that respects the dependencies between
                concepts—learning X before Y because that's how understanding
                actually builds.
              </p>
              <Link
                to="/createpath"
            ...
            <div className="space-y-8">
              ...
              <div className="relative">
                <div className="flex items-start gap-6">
                  <div className="flex flex-col items-center">
                    <div className="h-12 w-12 rounded-full bg-stone-900 text-white flex items-center justify-center text-lg font-semibold">
                      1
                    </div>
                  ...
                  <div className="flex-1 pb-8">
                    ...
                    <p className="text-sm leading-relaxed text-stone-500">
                      Choose items from your library to include in the path. You
                      can add more or remove items later as your understanding
                      evolves.
                    </p>
                  </div>
                </div>
              ...
              <div className="relative">
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1 pb-8">
                    ...
                    <p className="text-sm leading-relaxed text-stone-500">
                      Drag and drop to define the order. Think about what needs
                      to come first, what builds on what, and where transitions
                      make sense.
                    </p>
                  </div>
                </div>
              ...
              <div className="relative">
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1 pb-8">
                    <h3 className="text-lg font-semibold text-stone-900 mb-2">
                      Set visibility and categories
                    </h3>
                    <p className="text-sm leading-relaxed text-stone-500">
                      Choose who can see your path. Keep work-in-progress
                      private, share completed paths with the community, or keep
                      certain paths just for yourself.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm leading-relaxed text-stone-500">
                      Mark items complete, see your overall progress, and pick
                      up exactly where you left off. Learning stays continuous.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="border border-stone-200 rounded-md p-6 hover:border-stone-300 transition-colors">
            ...
            <p className="text-sm leading-relaxed text-stone-500">
              Step-by-step progression. Each item leads naturally to the next,
              like chapters in a book. Best for sequential skills.
            </p>
          </div>
          ...
          <div className="border border-stone-200 rounded-md p-6 hover:border-stone-300 transition-colors">
            ...
            <p className="text-sm leading-relaxed text-stone-500">
              Modules with a stronger framework. Group items into sections that
              can be approached somewhat independently. Best for broader topics.
            </p>
          </div>
          ...
          <div className="border border-stone-200 rounded-md p-6 hover:border-stone-300 transition-colors">
            ...
            <p className="text-sm leading-relaxed text-stone-500">
              A curated collection you can explore freely. Items are related but
              don't require a strict order. Best for reference material.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 pb-20">
        <div className="max-w-3xl">
          <blockquote className="text-2xl md:text-3xl font-light leading-snug text-stone-700">
            ...
            <span className="font-semibold text-emerald-700">map</span> that
            keeps you oriented when the terrain gets steep."
          </blockquote>
        </div>
      </section>
    </div>
