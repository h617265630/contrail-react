...
export function toUiResource(r: { id: number; title?: string; summary?: string; source_url?: unknown; resource_type?: unknown; platform?: string; thumbnail?: unknown }): UiResource {
  return {
    id: Number(r.id),
